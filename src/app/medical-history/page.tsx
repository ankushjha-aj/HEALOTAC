...
import { Search, Calendar, User, MapPin, FileText, Filter, Eye } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="card p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-2xl font-bold text-gray-900 dark:text-white">
                  {medicalRecords.reduce((sum, r) => sum + r.trainingDaysMissed, 0)}
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Training Days Missed</div>
              </div>
            </div>
          </div>
        </div>
